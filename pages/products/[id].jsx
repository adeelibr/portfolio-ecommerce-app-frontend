      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="p-4 lg:p-8 border">
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-gray-700 list-disc list-inside">{product?.details}</p>
          </div>
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 my-3">
            <div>
              <label className="text-text font-semibold">Brand</label>
              <p className="mt-2 text-accent list-disc list-inside">{product?.brand}</p>
            </div>

            <div>
              <label className="text-text font-semibold">Gender</label>
              <p className="mt-2 text-accent list-disc list-inside">{product?.gender}</p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 my-3">
            <div>
              ...
              <p className="mt-2 text-accent list-disc list-inside">{product?.sizes}</p>
            </div>

            <div>
              <label className="text-text font-semibold">Colors</label>
              <p className="mt-2 text-accent list-disc list-inside">{product?.colors}</p>
            </div>
          </div>

          <div className="mt-4 flex justify-between items-center">
            <h2 className="text-xl font-semibold text-gray-900">Price</h2>
            <p className="mt-2 text-primary font-semibold text-lg">$ {formatPrice(product.price)}</p>
          </div>

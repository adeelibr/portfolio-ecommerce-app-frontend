                    ...
                    <div key={product._id} className="mt-8">
                      <ul className="space-y-4">
                        <li className="flex items-center gap-4 justify-between">
                          <img src={product.images[0]} alt="" className="h-16 w-16 rounded object-cover" />
                          ...
                          <div>
                            ...
                            <dl className="mt-0.5 space-y-px text-[10px] text-text">
                              <p>
                                {cartProducts.filter((id) => id === product._id).length} x {product.price}
                  ...
                  <div className="grid grid-cols-12 gap-5">
                    ...
                    <div className="col-span-12 text-center w-full">
                      <button
                        ...
                        className="disabled block rounded bg-primary px-5 py-3 text-md text-text transition hover:bg-secondary hover:text-white w-full"
                      >
                        Checkout
                      </button>
                    </div>
    ...
    <>
      <div className="grid h-screen px-4 bg-white place-content-center">
        <div className="text-center">
          <p className="mt-4 text-text text-2xl">You should signup/login to view cart Items</p>
